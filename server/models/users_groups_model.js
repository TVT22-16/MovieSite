...
const sql = {
    ...
    DELETE_USERS_GROUPS: 'DELETE FROM users_groups WHERE username = $2 AND group_name = $1',
...
async function deleteUserGroup(group_name,username) {
    await pgPool.query(sql.DELETE_USERS_GROUPS, [group_name,username]);
    console.log(sql.DELETE_USERS_GROUPS, [group_name,username]);
  }
